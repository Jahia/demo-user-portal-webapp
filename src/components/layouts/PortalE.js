...
export const PortalE = () => {
    ...
    const defaultBlocks = useMemo(
        () => ['AccountProfile', 'Ads', 'BlocksStack', leadsOrOrderCmpName, 'ProductCard', 'Chart', 'MultiChart'],
        [leadsOrOrderCmpName]
    );

    const [blockItems, setBlockItems] = useState(userPreferences?.blocks?.PortalE?.main ||
        defaultBlocks
    );
